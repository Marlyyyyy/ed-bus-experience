...
public class DiaryFragment extends RoboFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        this.logAdapter = new LogAdapter(getActivity(), this.logs);
    ...
    private static class LogAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        public LogAdapter(Activity activity, ArrayList logs) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                ...
                distanceTextView.setText(String.valueOf(this.decimalFormat.format(this.log.getDistance())) + " m");
                averageSpeedTextView.setText(String.valueOf(this.decimalFormat.format(this.log.getAverageSpeed())) + " km/h");
